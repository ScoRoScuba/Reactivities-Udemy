...
namespace API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<UserDto>> Register(RegisterDto registerDto)
        {
            ...
            var message = $"<p>Please click link below to verify your email address:</p><p><a href='{verifyUrl}'>Click to verify email</a></p>";
        ...
        public async Task<ActionResult<UserDto>> FacebookLogin(string accessToken)
        {
            ...
            user = new AppUser()
            {
                ...
                {
                    new() {Id = "fb_" + (string) fbInfo.id, IsMain = true, Url = (string) fbInfo.picture.data.url}
                }
            };
            ...
            if (!result.Succeeded) return BadRequest("Problem saving user");
