    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseCsp(opt => opt
                ...
                .ScriptSources(s => s.Self().CustomSources("https://connect.facebook.net", "sha256-GjT1ZedJlVWJliz4GuARdvBzVS5EPBDJE8DVCzmFq+c=", "sha256-aiGNEEM+KqZfeDnKt740ApRc9oXiAKUArMX4l6SCym8="
